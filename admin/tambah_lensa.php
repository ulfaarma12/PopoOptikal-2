						...
						<div class="box-body">
							...
							<form action="" method="POST" enctype="multipart/form-data">
								...
								<div class="form-grup">
									...
									<input type="text" name="jenis_lensa" placeholder="Jenis Lensa" class="input-control" required>
								</div>
								<div class="form-grup">
							...
							<?php
								...
								if(isset($_POST['submit'])){
									...
									$jenis_lensa 	= htmlspecialchars(addslashes(ucwords($_POST['jenis_lensa'])));
									$ket 	= htmlspecialchars(addslashes(ucwords($_POST['keterangan'])));
									$harga 	= htmlspecialchars(addslashes(ucwords($_POST['harga'])));	
									$stok 	= htmlspecialchars(addslashes(ucwords($_POST['stok'])));
