						...
						<form action="">
							...
							<table class="table">
								...
								$no =1;
									...
									$lensa = mysqli_query($conn, "SELECT * FROM lensa $where ORDER BY id DESC");
								...
								<tr>
									...
									<td>
										<a href="edit_lensa.php?id=<?= $p['id'] ?>" title="Edit Data"><i class="fa fa-edit"></i></a>
										<a href="hapus.php?idlensa=<?= $p['id'] ?>" title="Hapus Data" onclick="return confirm('yakin ingin dihapus?')"><i class="fa fa-times"></i></a>
									</td>
								</tr>
									<?php }}else{ ?>
